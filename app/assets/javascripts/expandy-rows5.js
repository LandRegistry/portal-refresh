(function() {
  var expandyRowTriggers = document.querySelectorAll('.expandy-row-trigger5');
  ...
  function closeRow(row) {
    ...
    row.querySelector('.expandy-row-trigger5').innerHTML = '<img class="chevronsize" src="/public/images/icon_govuk_chevrondownBlack.svg">'
  }

  function openRow(row) {
    row.nextElementSibling.classList.remove('hide-row')
    row.classList.add('open')
    row.querySelector('.expandy-row-trigger5').innerHTML = '<img class="chevronsize" src="/public/images/icon_govuk_chevronupWhite.svg">'
  }
